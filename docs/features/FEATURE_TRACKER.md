...
| F-035 | First Overworld Location Transition Slice | Proposed | Clarifying | [F-035.md](./F-035.md) | 2026-06-21 | Detect explicit Enter on a recognized town and return a bounded transition request; destination loading remains separate. |
...
| F-037 | Location Session State and Resource Loading | Proposed | Proposed | [F-037.md](./F-037.md) | 2026-06-21 | Load validated transient town, castle, or dungeon resources behind an explicit session boundary. |
| F-038 | Two-Dimensional Location Navigation | Proposed | Proposed | [F-038.md](./F-038.md) | 2026-06-21 | Add non-wrapping movement, passability, feedback, and viewport rendering for town/castle sessions. |
| F-039 | First Town Entry and Sosaria Return Round Trip | Proposed | Proposed | [F-039.md](./F-039.md) | 2026-06-21 | Complete a town entry, navigation, save-restriction, and exact Sosaria restoration loop. |
