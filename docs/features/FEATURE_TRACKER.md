...
| F-048 | Combat Session Entry From Encounter Requests | Proposed | Proposed | [F-048.md](./F-048.md) | 2026-07-12 | Convert deferred encounter metadata into a validated transient combat session without starting the full combat loop. |
| F-049 | Combat Arena Render and Occupant State | Proposed | Proposed | [F-049.md](./F-049.md) | 2026-07-12 | Render resource-backed combat sessions with explicit party/monster occupant state. |
