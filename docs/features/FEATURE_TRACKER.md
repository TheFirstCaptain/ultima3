...
| F-044 | Dungeon Light and Torch State | Proposed | Proposed | [F-044.md](./F-044.md) | 2026-07-09 | Replace diagnostic dungeon visibility with bounded torch inventory, light state, decay, and redraw behavior. |
| F-045 | Dungeon Passive Turn Mechanics and Encounter Requests | Proposed | Proposed | [F-045.md](./F-045.md) | 2026-07-09 | Add post-command dungeon turn mechanics and deterministic random encounter request data without starting combat. |
| F-046 | Dungeon Special Tile Effects Slice | Proposed | Proposed | [F-046.md](./F-046.md) | 2026-07-09 | Add first non-interactive dungeon effects such as wind, traps, food theft, and writing through portable results. |
