...
| F-058 | Combat Presentation and Turn Feedback Pass | Proposed | Proposed | [F-058.md](./F-058.md) | 2026-07-17 | Improve visible combat feedback through bounded presentation events without changing rules. |
| F-059 | Combat Spell Coverage Tranche | Proposed | Proposed | [F-059.md](./F-059.md) | 2026-07-18 | Expand the current Mittar slice into a bounded set of combat spell commands with shared prompt, cost, targeting, mutation, and feedback rules. |
| F-060 | Combat Loot and End-State Rewards | Proposed | Proposed | [F-060.md](./F-060.md) | 2026-07-18 | Add bounded post-victory loot, gold, inventory, and combat cleanup handling without making combat state durable. |
