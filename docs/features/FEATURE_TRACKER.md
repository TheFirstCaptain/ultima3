...
| F-047 | Dungeon Interactive Tile Flows | Complete | Done | [F-047.md](./F-047.md) | 2026-07-13 | Keyboard-prompt-backed fountains, marks, Time Lord/message status, and first chest reward path complete with harness and shell coverage. |
| F-048 | Combat Session Entry From Encounter Requests | Complete | Done | [F-048.md](./F-048.md) | 2026-07-13 | Dungeon encounter requests now initialize a validated transient combat session while preserving the source dungeon session and leaving the full combat loop deferred. |
...
| F-055 | Combat Flee and Defeat Flow | Complete | Done | [F-055.md](./F-055.md) | 2026-07-18 | `F` now attempts bounded combat flee, successful flee restores the source dungeon session, failed flee consumes the turn, and all-active-party defeat restores safely with HP/status write-back. |
| F-056 | Dungeon Chest Trap and Equipment Rewards | Complete | Done | [F-056.md](./F-056.md) | 2026-07-18 | Dungeon chest traps and first weapon/armour inventory rewards complete with harness and shell coverage. |
| F-057 | First Town Service Slice | Complete | Done | [F-057.md](./F-057.md) | 2026-07-18 | First town healer service complete with prompt, HP/gold mutation, save policy, harness, and shell coverage. |
| F-058 | Combat Presentation and Turn Feedback Pass | Complete | Done | [F-058.md](./F-058.md) | 2026-07-21 | Bounded combat hit flashes and projectile traces now render as transient frame overlays without changing combat rules or save data. |
| F-059 | Combat Spell Coverage Tranche | Complete | Done | [F-059.md](./F-059.md) | 2026-07-21 | Added Fulgar and Noxum combat spell slices with shared validation, magic spend, damage, feedback, and save-domain write-back. |
| F-060 | Combat Loot and End-State Rewards | Complete | Done | [F-060.md](./F-060.md) | 2026-07-21 | Bounded post-victory gold and weapon/armour rewards now write through combat session state to the in-memory native document before dungeon restore. |
| F-061 | Town Economy and Vendor Services | Proposed | Proposed | [F-061.md](./F-061.md) | 2026-07-18 | Extend the first healer service into two practical vendor service shapes backed by native save mutations. |
| F-062 | Representative Destination Session Coverage | Proposed | Proposed | [F-062.md](./F-062.md) | 2026-07-18 | Generalize resource-backed sessions beyond LCB Towne and Dungeon Doom through a small documented set of representative destinations. |
| F-063 | Overworld Encounter and Transport Expansion | Proposed | Proposed | [F-063.md](./F-063.md) | 2026-07-18 | Add the next Sosaria systems for random encounters, outdoor-origin combat return policy, terrain hazards, and transport-aware movement. |
| F-064 | Playability Stabilization and Release Smoke | Proposed | Proposed | [F-064.md](./F-064.md) | 2026-07-18 | Final tranche pass after F-063: harden manual play workflows with command discoverability, save/load resilience, smoke scripts, and packaging-oriented validation. |
