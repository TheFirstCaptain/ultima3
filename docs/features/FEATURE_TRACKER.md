...
| F-050 | First Player Combat Command Slice | Proposed | Proposed | [F-050.md](./F-050.md) | 2026-07-12 | Add basic combat movement/pass and a bounded direction-supplied player attack path. |
| F-051 | First Monster Combat Turn Slice | Proposed | Proposed | [F-051.md](./F-051.md) | 2026-07-12 | Run deterministic bounded monster actions after handled player combat commands. |
