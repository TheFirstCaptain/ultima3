...
- `resource_fixture_tests.c` validates the read-only classic resource parser against `Resources/English.lproj/MainResources.rsrc`, confirms the default save-template records needed for fixture extraction, and asserts the archive inventory totals used by resource-planning docs.
