...
- `combat_player_command_tests.c` characterizes the first bounded player combat command contract from `Sources/UltimaSpellCombat.c`: cardinal movement, blocked movement, pass, attack direction prompting, melee hit/miss handoff, projectile and thrown-dagger line targeting, thrown-dagger inventory mutation, redraw/audio signaling, and explicit unsupported statuses.
