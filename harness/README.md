...
- `dungeon_special_tile_tests.c` validates the first portable non-interactive dungeon tile-effect contract for strange wind, traps, gremlin food theft, writing/deferred tile reporting, invalid inputs, deterministic party-member selection, bounded HP/status mutation, and food underflow prevention.
