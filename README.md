...
The next proposed backlog fills deferred combat spells, flee/defeat handling, dungeon chest rewards, first town services, and combat presentation feedback. See `F-054` through `F-058` in the feature tracker for the current proposed scope.
