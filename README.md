...
The next proposed backlog starts with combat victory/return, then fills deferred ranged attacks, combat spells, flee/defeat handling, dungeon chest rewards, first town services, and combat presentation feedback. See `F-052` through `F-058` in the feature tracker for the current proposed scope.
