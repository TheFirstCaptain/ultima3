...
The next proposed backlog fills first town services, combat presentation feedback, and broader spell coverage. See `F-057` and later entries in the feature tracker for the current proposed scope.
