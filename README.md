...
The next proposed tranche starts with combat presentation feedback, then expands combat spell coverage, victory loot, bounded town vendors, representative destination coverage, overworld encounters/transport, and a final playability stabilization pass. See `F-058` through `F-064` in the feature tracker for the current proposed scope.
