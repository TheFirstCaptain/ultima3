...
The next proposed backlog starts with player ranged attacks, then fills deferred combat spells, flee/defeat handling, dungeon chest rewards, first town services, and combat presentation feedback. See `F-053` through `F-058` in the feature tracker for the current proposed scope.
