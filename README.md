...
The next proposed backlog item is the first player combat command slice, followed by monster turns and combat victory/return. See `F-050` through `F-052` in the feature tracker for the current proposed scope.
