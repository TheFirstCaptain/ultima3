...
The next proposed backlog item is the first monster combat turn slice, followed by combat victory/return. See `F-051` and `F-052` in the feature tracker for the current proposed scope.
