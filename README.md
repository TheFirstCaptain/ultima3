...
The next proposed backlog fills flee/defeat handling, dungeon chest rewards, first town services, combat presentation feedback, and broader spell coverage. See `F-055` through `F-058` in the feature tracker for the current proposed scope.
